...
export default {
  ...
  ui: {
    ...
    languageLabel: 'భాష',
    introTitle: 'మీ అభిప్రాయం మమ్మల్ని మెరుగుపరుస్తుంది',
    introSubtitle: 'మీ అనుభవాన్ని పంచుకోవడానికి కొన్ని నిమిషాలు పడుతుంది. మీ అభిప్రాయం మేము మెరుగ్గా సేవ చేయడానికి సహాయపడుతుంది.',
    startReview: 'రివ్యూ ప్రారంభించండి',
