...
export default {
  ...
  ui: {
    ...
    finishTitle: 'గూగుల్‌లో పోస్ట్ చేయడం పూర్తి చేయండి',
    finishSteps: [
      'నక్షత్రాలను ట్యాప్ చేసి రేటింగ్ ఇవ్వండి',
      'రివ్యూ బాక్స్‌ను ట్యాప్ చేయండి',
      'మీ రివ్యూను పేస్ట్ చేయండి (లాంగ్-ప్రెస్ → పేస్ట్)',
      'పోస్ట్ ట్యాప్ చేయండి',
    ],
